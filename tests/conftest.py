...
def latest_deck_path(project_root: Path) -> Path:
    ...
    return project_root / "output" / "presentations" / "run_20251028_141202" / "AMP_Presentation_20251028_141202.pptx"
...
skipif_no_deck = pytest.mark.skipif(
    not Path("output/presentations/run_20251028_141202/AMP_Presentation_20251028_141202.pptx").exists(),
